...
const FORM_DATA = {
  ...
  comoPierciben:
    'Como alguien que ya lo hizo, que habla sin filtros y sin poses, que no vende humo sino resultados reales. Directo, accesible y confiable.',
  perfilDemografico:
    'Hombres y mujeres de 20 a 35 anos en Latinoamerica, con o sin experiencia en negocios, que buscan una fuente de ingresos adicional o principal desde internet con un celular o computadora basica.',
  problemaPrincipal:
    'No saben como empezar a vender por internet sin tener capital, sin inventario propio, y sin conocimiento tecnico. Se sienten perdidos ante la cantidad de informacion contradictoria y estafas en el mercado.',
  resultadoDeseado:
    'Ganar entre 3000 y 5000 USD por mes de forma consistente vendiendo productos fisicos por internet, con un negocio que funcione de manera semi-automatica y les de libertad de tiempo y ubicacion.',
  ...
  costoNoActuar:
    'Cada mes que pasa sin iniciar es un mes mas de depender de un solo ingreso sin ahorros ni libertad. El costo de no actuar es seguir exactamente igual en 1, 2 o 5 anos.',
  errorPrincipal:
    'El error principal es buscar el negocio perfecto antes de actuar. La gente pasa meses investigando y esperando el momento ideal que nunca llega. La accion imperfecta supera siempre a la inaccion perfecta.',
  aQuienNoAyudo:
    'Personas que buscan hacerse ricas sin esfuerzo, que no dedican al menos 2 horas diarias, o que quieren resultados sin seguir el proceso.',
  queOfrece:
    'Mentoria grupal e individual en ecommerce y dropshipping para latinoamericanos. Incluye metodo paso a paso, comunidad activa, plantillas y soporte directo con Alexander.',
  promesaRealista:
    'En 90 dias tendras tu tienda online funcionando, tus primeras ventas reales, y un sistema basico de operacion que puedes escalar hasta tus primeros 1000 USD al mes.',
  precioInversion: 'Programa grupal desde 497 USD - Mentoria individual desde 1500 USD',
  formatoEntrega:
    'Clases en vivo semanales, comunidad privada de WhatsApp, modulos grabados y sesiones 1 a 1 opcionales. Todo 100% online.',
  garantia: '7 dias de satisfaccion o devolucion sin preguntas',
  noPromete:
    'No promete resultados en dias, no garantiza ingresos especificos, no es un sistema automatico sin esfuerzo.',
  resultadosClientes:
  ...
  estiloComuncacional:
    'Directo, sin filtros, como si le hablaras a un amigo cercano que te da la verdad sin azucar. Usa ejemplos reales, numeros concretos y no tiene miedo de hablar de los fracasos propios.',
  ...
  prohibiciones: [
    ...
    'No hablar de competidores con irrespeto',
  ...
  mensajeCentral:
    'Cualquier persona puede ganar de 3000 a 5000 USD por mes vendiendo productos fisicos por internet sin inventario, sin experiencia previa y desde cualquier lugar de Latinoamerica.',
  pilares: [
  ...
  historiaOrigen:
    'Empece vendiendo en internet desde un apartamento en Bogota sin capital, con una laptop prestada y sin saber nada de ecommerce. Cometi todos los errores posibles. Aprendi cada detalle del sistema y eventualmente construi negocios que me dieron la libertad que buscaba.',
  historiaBatallas:
    'Tuve un negocio que colapso por una mala decision de proveedor y perdi todo lo invertido. Hubo meses donde no sabia si iba a poder pagar el arriendo. Mi familia no creia en lo que hacia. Esos momentos me dan autoridad para hablar de resiliencia y metodo.',
  historiaLogros:
    'Construi un portafolio de negocios digitales que factura consistentemente. Funde KREOON e Infiny Group. Ayude a mas de 200 personas a generar sus primeros ingresos online. Construi una comunidad de mas de 50000 seguidores interesados en ecommerce real.',
  objetivoPrincipal: 'leads' as const,
...
export default function SeedPage() {
  ...
  return (
    ...
    >
      <p style={{ color: '#22c55e', fontSize: '1.1rem', fontWeight: 700 }}>
        Datos guardados en sessionStorage
      </p>
      <p style={{ color: '#a8a29e', fontSize: '0.85rem' }}>
        Abre la consola (F12) para confirmar, luego haz clic abajo.
      </p>
      <a
        href="/form"
        style={{
